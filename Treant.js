...
;( function() {
    ...
    TreeNode.prototype = {
        ...
        reset: function( nodeStructure, id, parentId, tree, stackParentId ) {
            ...
            // document.getElementById('a').innerHTML = '<a href=https://www.yahoo.com/news/>Yahoo News - Latest News & Headlines   </a>';
        ...
        if (this.text) {
            for (var key in this.text) {
                ...
                if (key.startsWith("data-")) {
                    ...
                    // this.text[key].href = 'a'
                    // this.text[key].target = 'sometext'
